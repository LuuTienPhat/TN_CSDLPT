...
class Database
{
    ...
    /// {0} : id
    /// </summary>
    public const string SP_INSERT_SUBJECT = "EXEC SP_INSERT_SUBJECT {0}, {1}";
    public const string SP_UPDATE_SUBJECT = "EXEC SP_UPDATE_SUBJECT {0}, {1}";
    public const string SP_DELETE_SUBJECT = "EXEC SP_DELETE_SUBJECT {0}";
